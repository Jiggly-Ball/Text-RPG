...
from typing import Sequence, Union, Optional, Literal, overload, TYPE_CHECKING
from terminal import Colour, ReturnType
...
class Terminal:
    ...
    def input_terminal(
        self,
        prompt: str,
        max_input_char: Optional[int],
        text_colour: Optional[Colour],
        text_bg: Optional[Colour],
        text_delay: Optional[int],
    ...
    def input_terminal(
        self,
        prompt: str,
        max_input_char: Optional[int] = None,
        text_colour: Optional[Colour] = None,
        text_bg: Optional[Colour] = None,
        text_delay: Optional[int] = None,
        decode_input: bool = True,
        ...
        def main(stdscr):
            ...
            text_bg_ = text_bg or self.text_bg
            text_delay_ = text_delay or self.text_delay
            max_input_char_ = max_input_char or self.max_input_char

            curses.init_pair(1, text_colour_.value, text_bg_.value)

            for letter in prompt:
                if column == self.__max_wrap(stdscr):
                    row += 1
                    column = 0
    ...
    def option_terminal(
        ...
        def main(stdscr):
            ...
            for letter in text:
                ...
                if text_col == self.__max_wrap(stdscr):
                    text_row += 1
                    text_col = 0
                    option_row += 1
                    formatted_text += "\n"
